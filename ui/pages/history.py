...
class HistoryPage(QWidget):
    def __init__(self) -> None:
        ...
        subtitle = QLabel("Only operation details are stored locally—never document contents.")
        subtitle.setObjectName("subtitle")
        layout.addWidget(subtitle)
        self.table = QTableWidget(0, 6)
        self.table.setHorizontalHeaderLabels(["Date", "Filename", "Action", "Original", "Output", "Status"])
    ...
    def clear(self) -> None:
        if (
            QMessageBox.question(self, "Clear history", "Delete all local history entries?")
