...
class HistoryPage(QWidget):
    def __init__(self) -> None:
        ...
        row = QHBoxLayout(); refresh = QPushButton("Refresh"); refresh.setObjectName("ghost"); refresh.clicked.connect(self.refresh); open_file = QPushButton("Open File"); open_file.setObjectName("ghost"); open_file.clicked.connect(self.open_file); open_folder = QPushButton("Open Folder"); open_folder.setObjectName("ghost"); open_folder.clicked.connect(self.open_folder); delete = QPushButton("Delete Entry"); delete.setObjectName("danger"); delete.clicked.connect(self.delete); clear = QPushButton("Clear History"); clear.setObjectName("danger"); clear.clicked.connect(self.clear)
