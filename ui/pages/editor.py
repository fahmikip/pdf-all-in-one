...
class EditorPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        top = QHBoxLayout()
        choose = QPushButton("Choose PDF"); choose.setObjectName("ghost"); choose.clicked.connect(self._choose_pdf); top.addWidget(choose)
        ...
        self.save_btn = QPushButton("Save PDF"); self.save_btn.setObjectName("success"); self.save_btn.setEnabled(False); self.save_btn.clicked.connect(self._save); top.addWidget(self.save_btn)
        root.addLayout(top)

        middle = QHBoxLayout()
        controls = QVBoxLayout()
        actions = QHBoxLayout()
        add_image = QPushButton("Add Image"); add_image.setObjectName("info"); add_image.clicked.connect(self._add_image); actions.addWidget(add_image)
        add_text = QPushButton("Add Text"); add_text.setObjectName("success"); add_text.clicked.connect(self._add_text); actions.addWidget(add_text)
        delete = QPushButton("Delete"); delete.setObjectName("danger"); delete.clicked.connect(self._delete_selected); actions.addWidget(delete)
