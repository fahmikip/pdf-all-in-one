"""Accessible drag-and-drop file target with a frosted-glass design."""
...
class DropZone(QFrame):
    ...
    def __init__(self, title: str = "Seret & Lepas PDF di Sini", multiple: bool = False) -> None:
        super().__init__()
        ...
        hint = QLabel("Dokumen Anda diproses secara lokal dan tidak pernah diunggah.")
        hint.setObjectName("muted")
        hint.setAlignment(Qt.AlignmentFlag.AlignHCenter)
        layout.addWidget(hint)
        choose = QPushButton("Pilih File")
